        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark" aria-current="page">Monitoring Evaluasi</li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ubah Monitoring Evaluasi</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Ubah Monitoring Evaluasi</h6>
            </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6 class="text-uppercase">Form Ubah Monitoring Evaluasi</h6>
                        <a href="{{ route('monev') }}" class="btn btn-secondary btn-sm mb-0">
                        ...
                        <form action="{{ route('monev.update', $monev->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-light"
                                        value="{{ $monev->rencanakerja->rencana_aksi ?? 'Data tidak ditemukan' }}" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <fieldset class="border p-3 rounded-3 mb-3">
                                ...
                                <button type="button" class="btn btn-primary btn-sm tambah-utama mb-3"
                                    data-bs-toggle="modal" data-bs-target="#anggaranModal">
                                            ...
                                            @for ($i = 1; $i <= 4; $i++)
                                                @if (
                                                    ...
                                                    <tr id="{{ $uniqueId }}" data-tw="{{ $i }}">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button"
                                                                class="btn btn-danger hapus-triwulan-row"
            ...
            $('#tambah-triwulan-ke-tabel').on('click', function() {
                ...
                const tableRow = `
                    <tr id="${uniqueId}" data-tw="${tw_index}">
                        ...
                        <td>${keterangan || '-'}</td>
                        <td class="text-center">
                            <button type="button" class="btn btn-danger  hapus-triwulan-row" data-target="hidden-${uniqueId}">
                                 <i class="fa-solid fa-trash"></i>
                            </button>
                        </td>
                    </tr>
