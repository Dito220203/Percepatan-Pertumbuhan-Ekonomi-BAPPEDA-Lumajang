<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <ul class="navbar-nav">
        ...
        @if (auth()->guard('pengguna')->user()->level == 'Super Admin')
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('subprogram') ? 'active' : '' }}"
                    href="{{ route('subprogram') }}" wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('rencana6tahun') ? 'active' : '' }}"
                    href="{{ route('rencana6tahun') }}" wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('rencanakerja') ? 'active' : '' }}"
                    href="{{ route('rencanakerja') }}" wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('monev') ? 'active' : '' }}" href="{{ route('monev') }}"
                    wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('progres') ? 'active' : '' }}" href="{{ route('progres') }}"
                    wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('regulasi') ? 'active' : '' }}"
                    href="{{ route('regulasi') }}" wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2  text-xs font-weight-bolder opacity-6">Pages</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('opd') ? 'active' : '' }}" href="{{ route('opd') }}"
                    wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('pengguna') ? 'active' : '' }}"
                    href="{{ route('pengguna') }}" wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @elseif (auth()->guard('pengguna')->user()->level == 'Admin')
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('progres') ? 'active' : '' }}"
                    href="{{ route('progres') }}" wire:navigate>
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-bars-progress text-dark"></i>
                    </div>
