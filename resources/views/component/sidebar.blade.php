<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('subprogram') ? 'active' : '' }}" href="{{ route('subprogram') }}"
                wire:navigate>
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('regulasi') ? 'active' : '' }}" href="{{ route('regulasi') }}"
                wire:navigate>
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('pengguna') ? 'active' : '' }}" href="{{ route('pengguna') }}"
                wire:navigate>
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
