...
class RencanaAksi_6TahunController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.rencanaaksi.index', compact('rencanaAksi', 'tahuns'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.rencanaaksi.create', compact('subprogram', 'opds'));
    }
    // BARU
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.rencanaaksi.update', compact('rencanaAksi', 'subprogram', 'opds'));
    }
