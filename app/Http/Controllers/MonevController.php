   ...
   public function index(Request $request)
    {
        ...
        return view('admin.monev.index', compact('monev', 'tahuns', 'allOpds'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.monev.create', compact('subprogram', 'rencana', 'opd'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.monev.update', compact('monev', 'subprogram', 'rencana', 'opd'));
    }
